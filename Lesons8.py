...
print("Ввидте количество чисел:")
B = int(input())
print("Ввидте числа через пробел:")
res1 = list(map(int, input().split()))
res1.insert(0, res1.pop()) 
# В ячейку с индексом 0 мы вставляем (.insert) значение удаленное(.pop) методом 
